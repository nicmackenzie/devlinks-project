...
User.create(user_name: 'Angela Yu', email: 'angela@techbrew.io',devtype: 'full stack',experience: 2,image_url: 'https://igqjyslipxclzwcefxrb.supabase.co/storage/v1/object/public/avatars/angela_yu.jpg')
User.create(user_name: 'Brad Pitt', email: 'pitt@brajelina.org',devtype: 'frontend',experience: 3,image_url: 'https://igqjyslipxclzwcefxrb.supabase.co/storage/v1/object/public/avatars/brad_pitt.jpg')
User.create(user_name: 'Angelina Jolie', email: 'angelina@brajelina.org',devtype: 'backend',experience: 1,image_url: 'https://igqjyslipxclzwcefxrb.supabase.co/storage/v1/object/public/avatars/jelina_jolie.jpg')
